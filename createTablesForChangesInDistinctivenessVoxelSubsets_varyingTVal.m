...
% distinctiveness per year for the union of selective voxels defined by
% different t-values.
close all
clear all
...
% to create the tables for the union of the selective voxels defined by
% different t-values use the following data sets:
% (1) for a t-value=1 use: fileName ='RSM_zscore_29children_vtc_selective_8categories_union_t1_noSubID'
% (2) for a t-value=2 use: fileName ='RSM_zscore_29children_vtc_selective_8categories_union_t2_noSubID'
% (3) for a t-value=3 use: fileName ='RSM_zscore_29children_vtc_selective_8categories_union_t3_noSubID'
% (4) for a t-value=4 use: fileName ='RSM_zscore_29children_vtc_selective_8categories_union_t4_noSubID'
% (5) for a t-value=5 use: fileName ='RSM_zscore_29children_vtc_selective_8categories_union_t5_noSubID'

fileName = 'RSM_zscore_29children_vtc_selective_8categories_union_t5_noSubID';
